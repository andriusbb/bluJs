...
function Blu$3 (options) {
  if ("development" !== 'production' &&
    !(this instanceof Blu$3)) {
  ...
  if (options.components) {
    ...
    for (var key in components) {
      ...
      if (isPlainObject(def)) {
        components[key] = Blu$3.extend(def);
      }
    }
  }
}
...
function mergeOptions (
  ...
  if (child.mixins) {
    for (var i = 0, l = child.mixins.length; i < l; i++) {
      ...
      if (mixin.prototype instanceof Blu$3) {
        mixin = mixin.options;
      }
...
Object.defineProperty(Blu$3.prototype, '$isServer', {
...
Blu$3.config.isUnknownElement = isUnknownElement;
Blu$3.config.isReservedTag = isReservedTag;
Blu$3.config.getTagNamespace = getTagNamespace;
Blu$3.config.mustUseProp = mustUseProp;

// install platform runtime directives & components
extend(Blu$3.options.directives, platformDirectives);
extend(Blu$3.options.components, platformComponents);

// install platform patch function
Blu$3.prototype.__patch__ = config._isServer ? noop : patch$1;

// wrap mount
Blu$3.prototype.$mount = function (
  el,
  hydrating
) {
...
var mount = Blu$3.prototype.$mount;
Blu$3.prototype.$mount = function (
  el,
  hydrating
) {
...
Blu$3.compile = compileToFunctions;
